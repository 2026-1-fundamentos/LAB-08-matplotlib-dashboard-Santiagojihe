...
def pregunta_01():
    ...
    * `Weight_in_gms`
    ...
    # 1. Crear la carpeta 'docs' si no existe obligatoriamente
    os.makedirs("docs", exist_ok=True)

    # 2. Leer los datos desde la carpeta especificada
    ...
    plt.ylabel("")  # Remover etiqueta vertical sobrante de pandas
